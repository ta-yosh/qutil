    ...
    public JDialog  dbUpdate(JButton execBtn,final QkanExecTransaction dbexec) throws Exception {
      ...
      if (dbOutPath==null) {
        ...
        while (!kstat) {
          ...
          iTable = new QkanTsusyoData(uri,getProperty("DBConfig/UserName"),getProperty("DBConfig/Password"));
          if (iTable.Rows<0) {
      ...
      JLabel title = new JLabel(" 給管鳥 通所介護利用情報");
      ...
      centerP.add(iTable.searchCondition());
