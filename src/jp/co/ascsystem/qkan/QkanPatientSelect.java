...
public class QkanPatientSelect {
    ...
    public QkanPatientSelect(String dbUri,String dbUser,String dbPass) {
      ...
      careRate.put("6","»ö¶ÈÂÐ¾Ý¼Ô");
      careRate.put("01","Èó³ºÅö");
      careRate.put("06","»ö¶ÈÂÐ¾Ý¼Ô");
    ...
    public JScrollPane getScrollList() {
      ...
      fieldName.addElement("ÊÝ¸±¼ÔÈÖ¹æ");
      fieldName.addElement("µëÉÕÎ¨");
      fieldName.addElement("ºîÀ®¶èÊ¬");
      fieldName.addElement("»ö¶È½êÈÖ¹æ");
    ...
    public String PDFout() {
      ...
      if (pdf.openPDF("ÍøÍÑ¼Ô´ðËÜ¾ðÊó°ìÍ÷")) {
