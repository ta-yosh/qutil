...
public class QkanHouRehaUtil extends QkanPatientImport {
  ...
  QkanHouRehaData tTable;

  public QkanHouRehaUtil() {
...
!checkDBPath(dbPath)) {
        ...
        tTable = new QkanHouRehaData(uri,getProperty("doc/DBConfig/UserName"),getProperty("doc/DBConfig/Password"));
        if (tTable.Rows<0) {
        ...
        if (tTable.Rows==0) {
          if ( JOptionPane.showConfirmDialog(
                ...
                "訪問リハ利用者情報CSV書き出し",JOptionPane.YES_NO_OPTION
    ...
    JLabel title = new JLabel(" 給管鳥 訪問リハ利用者情報");
  ...
  public void execCsvOut() {
    ...
    final JLabel tit1 = new JLabel("【訪問リハ情報CSV書き出し】");
  ...
  public static void main(String[] args) {
    QkanHouRehaUtil ipi = new QkanHouRehaUtil();
    try {
      ipi.execCsvOut();
      //System.exit(0);
