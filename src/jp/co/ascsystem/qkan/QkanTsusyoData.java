...
public class QkanTsusyoData {
    ...
    public void setUnit(String dat) {
      ...
      //if (osn.equals("Win")) {
        tValue.put("1150104",(new String[] {"","2\uff5e3時間","3\uff5e5時間","5\uff5e7時間","7\uff5e9時間","9\uff5e10時間","10\uff5e11時間","11\uff5e12時間"}));
...
*/
      ...
      tValue.put("1150117",(new String[] {"","無","I","II","III"}));
      ...
      yValue.put("1650109",(new String[] {"","無","I","II","無","I","II"}));
      ...
      if (dbm.connect()) {
        ...
        taUnit.put("1150119", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,0).toString())})); //個別１
        taUnit.put("1150120", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,1).toString())})); //個別２
        taUnit.put("1150106", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,2).toString())})); //入浴
        taUnit.put("1150116", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,3).toString())})); //栄養
        taUnit.put("1150112", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,4).toString())})); //口腔
        taUnit.put("16", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,5).toString())})); //同一住居
        taUnit.put("1150117", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,6).toString()),    //サービスI
          Integer.parseInt(dbm.getData(1,7).toString()),    //サービスII
          Integer.parseInt(dbm.getData(1,8).toString())})); //サービスIII
        taUnit.put("KAIZEN", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,9).toString()),     //処遇改善I
          Integer.parseInt(dbm.getData(1,10).toString()),    //処遇改善II
          Integer.parseInt(dbm.getData(1,11).toString())})); //処遇改善II
        taUnit.put("1150115", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,12).toString())})); //若年
        taUnit.put("12",(new int[] {0,0,
          Integer.parseInt(dbm.getData(1,13).toString())})); //中山間
        taKaizenCode = new String[] {"","",
          dbm.getData(3,9).toString(),     //処遇改善I
          dbm.getData(3,10).toString(),    //処遇改善II
          dbm.getData(3,11).toString() //処遇改善II
        };

        yaUnit.put("1650104", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,14).toString())})); //予運動
        yaUnit.put("1650105", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,15).toString())})); //予栄養
        yaUnit.put("1650106", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,16).toString())})); //予口腔
        yaUnit.put("1650107", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,17).toString())})); //予評価
        yaUnit.put("MULTI", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,18).toString()),    //予複数I1
          Integer.parseInt(dbm.getData(1,19).toString()),    //予複数I2
          Integer.parseInt(dbm.getData(1,20).toString()),    //予複数I3
          Integer.parseInt(dbm.getData(1,21).toString())})); //予複数II
        yaUnit.put("1650103", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,22).toString())})); //予向上
        yaUnit.put("1650109", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,23).toString()),    //予サービスI1
          Integer.parseInt(dbm.getData(1,25).toString()),0,0,//予サービスI2
          Integer.parseInt(dbm.getData(1,24).toString()),    //予サービスII1
          Integer.parseInt(dbm.getData(1,26).toString())})); //予サービスII2
        yaUnit.put("16", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,27).toString()),    //予同一住所
          Integer.parseInt(dbm.getData(1,28).toString())})); //予同一住所
        yaUnit.put("1650108", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,29).toString())})); //予若年
        yaUnit.put("KAIZEN", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,30).toString()),     //処遇改善I
          Integer.parseInt(dbm.getData(1,31).toString()),    //処遇改善II
          Integer.parseInt(dbm.getData(1,32).toString())})); //処遇改善II
        yaUnit.put("12", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,33).toString()),    //予中山間
          Integer.parseInt(dbm.getData(1,34).toString())})); //予中山間
        yaKaizenCode = new String[] {"","",
          dbm.getData(3,30).toString(),     //処遇改善I
          dbm.getData(3,31).toString(),    //処遇改善II
          dbm.getData(3,32).toString() //処遇改善II
        };
...
//    }
      ...
      width[cid++] = 12; //氏名
      ctype[cid] = 2; // 0 - normal 1 - add comma 2 - align right
      width[cid++] = Float.parseFloat("4.5"); //年齢
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("7.5"); //要介護度
      ctype[cid] = 7;
      width[cid++] = 5; //種類
      if (targetDay>0) {
        ctype[cid] = 7;
      ...
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //人員
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("5.0"); //中山間
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //入浴
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //個別I
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("5.0"); //個別II
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //若年
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //栄養
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //口腔
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //同住
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //サー
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //生活
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //運動
      ctype[cid] = 7;
      width[cid++] = Float.parseFloat("4.5"); //評価
      ctype[cid] = 2;
      width[cid++] = Float.parseFloat("9.0"); //改善
      ctype[cid] = 7;
      if (targetDay==0) {
        ctype[cid] = 2; // 0 - normal 1 - add comma 2 - align right
      }
      width[cid++] = Float.parseFloat("4.5"); //回数
