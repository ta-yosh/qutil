...
;
      ...
      if (dbm.connect()) {
        ...
        taUnit.put("1150121", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,3).toString())})); //認知症
        taUnit.put("1150122", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,4).toString())})); //中重度
        taUnit.put("1150116", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,5).toString())})); //栄養
        taUnit.put("1150112", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,6).toString())})); //口腔
        taUnit.put("16", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,7).toString())})); //同一住居
        taUnit.put("18", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,8).toString()),    //送迎減算片道
          Integer.parseInt(dbm.getData(1,9).toString())*2})); //送迎減算往復
        taUnit.put("1150123", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,10).toString())})); //個別送迎強化
        taUnit.put("1150124", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,11).toString())})); //入浴強化
        taUnit.put("1150117", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,13).toString()),    //サービスI2(ロ)
          Integer.parseInt(dbm.getData(1,14).toString()),    //サービスII
          Integer.parseInt(dbm.getData(1,15).toString()),    //サービスIII
          Integer.parseInt(dbm.getData(1,12).toString())})); //サービスI1(イ)
        taUnit.put("KAIZEN", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,16).toString()),     //処遇改善II
          Integer.parseInt(dbm.getData(1,17).toString()),    //処遇改善III
          Integer.parseInt(dbm.getData(1,18).toString()),    //処遇改善IV
          Integer.parseInt(dbm.getData(1,19).toString())})); //処遇改善I
        taUnit.put("1150115", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,20).toString())})); //若年
        taUnit.put("12",(new int[] {0,0,
          Integer.parseInt(dbm.getData(1,21).toString())})); //中山間
        taKaizenCode = new String[] {"","",
          dbm.getData(3,16).toString(),     //処遇改善II
          dbm.getData(3,17).toString(),     //処遇改善III
          dbm.getData(3,18).toString(),    //処遇改善IV
          dbm.getData(3,19).toString() //処遇改善I
        };

        yaUnit.put("1650104", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,22).toString())})); //予運動
        yaUnit.put("1650105", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,23).toString())})); //予栄養
        yaUnit.put("1650106", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,24).toString())})); //予口腔
        yaUnit.put("1650107", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,25).toString())})); //予評価
        yaUnit.put("MULTI", (new int[] {0,0,0,
          Integer.parseInt(dbm.getData(1,26).toString()),0,  //予複数I1
          Integer.parseInt(dbm.getData(1,27).toString()),    //予複数I2
          Integer.parseInt(dbm.getData(1,28).toString()),    //予複数I3
          Integer.parseInt(dbm.getData(1,29).toString())})); //予複数II
        yaUnit.put("1650103", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,30).toString())})); //予向上
        yaUnit.put("1650109", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,31).toString()),    //予サービスI21(ロ)
          Integer.parseInt(dbm.getData(1,33).toString()),    //予サービスII1
          Integer.parseInt(dbm.getData(1,37).toString()),0,  //予サービスI11(イ)
          Integer.parseInt(dbm.getData(1,32).toString()),    //予サービスI22(ロ)
          Integer.parseInt(dbm.getData(1,34).toString()),    //予サービスII2
          Integer.parseInt(dbm.getData(1,38).toString())})); //予サービスI12(イ)
        yaUnit.put("16", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,35).toString()),0,  //予同一住所
          Integer.parseInt(dbm.getData(1,36).toString())})); //予同一住所
        yaUnit.put("1650108", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,39).toString())})); //予若年
        yaUnit.put("KAIZEN", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,41).toString()),     //処遇改善II
          Integer.parseInt(dbm.getData(1,42).toString()),    //処遇改善III
          Integer.parseInt(dbm.getData(1,43).toString()),    //処遇改善IV
          Integer.parseInt(dbm.getData(1,40).toString())})); //処遇改善I
        yaUnit.put("12", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,44).toString()),    //予中山間
          Integer.parseInt(dbm.getData(1,45).toString())})); //予中山間日割
        yaKaizenCode = new String[] {"","",
          dbm.getData(3,41).toString(),     //処遇改善II
          dbm.getData(3,42).toString(),    //処遇改善III
          dbm.getData(3,43).toString(),    //処遇改善IV 
          dbm.getData(3,40).toString() //処遇改善I
        };
