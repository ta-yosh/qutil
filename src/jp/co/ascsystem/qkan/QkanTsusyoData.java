...
;
      ...
      if (dbm.connect()) {
        ...
        yaUnit.put("KAIZEN", (new int[] {0,0,
          Integer.parseInt(dbm.getData(1,COLU+1).toString()),     //処遇改善III(2017以前はII)
          Integer.parseInt(dbm.getData(1,COLU+2).toString()),    //処遇改善IV(2017以前はIII)
          Integer.parseInt(dbm.getData(1,COLU+3).toString()),    //処遇改善V(2017以前はIV)
          Integer.parseInt(dbm.getData(1,COLU).toString()), //処遇改善II(2017以前はI)
          (!KAI17) ? 0:Integer.parseInt(dbm.getData(1,yKaitemp).toString())})); //処遇改善I
        COLU += 4;
        ...
        yaKaizenCode = new String[] {"","",
          dbm.getData(3,COLU++).toString(),     //処遇改善IIII(2017以前はI)
          dbm.getData(3,COLU++).toString(),    //処遇改善IV(2017以前はIII)
          dbm.getData(3,COLU).toString(),    //処遇改善V(2017以前はIV )
          dbm.getData(3,COLU-3).toString(), //処遇改善II(2017以前はI)
          (!KAI17) ? "":dbm.getData(3,yKaitemp).toString() //処遇改善I
        };
