...
public class QkanHouKaiUtil extends QkanPatientImport {
  ...
  QkanHouKaiData tTable;

  public QkanHouKaiUtil() {
  ...
  public JDialog dbUpdate(JButton execBtn,final QkanExecTransaction dbexec) throws Exception {
    ...
    */
      ...
      contentPane.setBackground(new Color(210,210,230));
      boolean kstat = false;
      while (!kstat) {
...
!checkDBPath(dbPath)) {
        ...
        tTable = new QkanHouKaiData(uri,getProperty("doc/DBConfig/UserName"),getProperty("doc/DBConfig/Password"));
        if (tTable.Rows<0) {
        ...
        if (tTable.Rows==0) {
          if ( JOptionPane.showConfirmDialog(
                ...
                "訪問介護利用者情報CSV書き出し",JOptionPane.YES_NO_OPTION
    ...
    JLabel title = new JLabel(" 給管鳥 訪問介護利用者情報");
  ...
  public void execCsvOut() {
    ...
    final JLabel tit1 = new JLabel("【訪問介護情報CSV書き出し】");
  ...
  public static void main(String[] args) {
    QkanHouKaiUtil ipi = new QkanHouKaiUtil();
    try {
      ipi.execCsvOut();
      //System.exit(0);
